...
| Source | Row |
|---|---|
| `BofaCardStatementParser.kt:43` | `PAYMENT FROM CHK 3119 CONF#1h0jziv8s ... -350.00` |
| `BofaCsvStatementParser.kt:31` | `Online Banking transfer from SAV 1490 Confirmation# 1894043660 ... 30.00` |
| `currentTransaction_4146.csv` | `PAYMENT FROM SAV 1490 CONF#v1ikbyqeg ... 1300.00` |
...
7. Unpaired `PAYMENT FROM SAV 1490` -> `SUSPECTED_TRANSFER`.
