...
class LedgerStatementAgentTest {
    private fun response(
        ...
        closing: String,
        txns: String,
        accountId: String = "4111111111117823",
        currency: String = "USD",
    ) = """
    ...
    fun `quarantines when the statement prints no anchor of any kind`() {
        val raw = """
            {"accountId": "4111111111117823", "currency": "USD",
    ...
    fun `a spaced account number is normalized to match the deterministic parsers`() {
        // Without this, the same card arrives as "4111 1111 1111 7823" here
        // and "4111111111117823" from BofaCardStatementParser, and every
        // accountId grouping key splits one account into two.
        val raw = response(
            opening = "0.00", closing = "100.00",
            txns = txn("2026-01-02", "PAYROLL", "100.00"),
            accountId = "4111 1111 1111 7823",
        )
