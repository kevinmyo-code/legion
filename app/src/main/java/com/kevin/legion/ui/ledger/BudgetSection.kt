        ...
        BudgetSection(
            ...
            budget = BudgetVsActual(
                ...
                excludedOwnAccountMovements = ExcludedOwnAccountMovements(
                    ...
                    rows = listOf(
                        LedgerTransaction(
                            id = 101, sourceFile = "eStmt.pdf", accountId = "411111113119",
                            currency = LedgerCurrency.USD, txnDate = System.currentTimeMillis(),
                            description = "Online Banking payment to CRD 4146 Confirmation# 0649409616",
...
private fun PreviewExcludedOwnAccountMovements() = LegionTheme {
    ExcludedOwnAccountMovementsScreen(
        ...
        excluded = ExcludedOwnAccountMovements(
            ...
            rows = listOf(
                LedgerTransaction(
                    id = 1, sourceFile = "eStmt.pdf", accountId = "411111113119",
                    currency = LedgerCurrency.USD, txnDate = System.currentTimeMillis(),
                    description = "Online Banking payment to CRD 4146 Confirmation# 0649409616",
                    amountCents = -34_011L, lineRef = "1", ingestMethod = IngestMethod.DETERMINISTIC,
                ),
                LedgerTransaction(
                    id = 2, sourceFile = "eStmt.pdf", accountId = "411111113119",
                    currency = LedgerCurrency.USD, txnDate = System.currentTimeMillis(),
                    description = "Mobile Banking payment to CRD 4146 Confirmation# 14lmchyt7",
