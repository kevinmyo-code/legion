 ...
 *
 * [BofaCardCsvStatementParser] stores `accountId = "4146"` (the filename's
 ...
 * `"5555555555554146"`, from the monthly PDF for the SAME physical card.
 ...
 * looser shape also matches `PETCO 5421`, `CIRCLE K # 41490`, `HILL 71 RD`, and half a dozen other
 ...
 * savings account ("SAV 1490") that has never itself had a statement imported - no accountId on
 ...
 * last-4 (`"4146"`), which is not a secret and reads worse as `"****4146"`.
