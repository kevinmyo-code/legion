 ...
 *
 * `accountId` is the last-4 parsed from the FILENAME (`currentTransaction_7823.csv`
 * -> `"7823"`) - call 2 of ticket 12's resolution. This export prints no
...
object BofaCardCsvStatementParser {
    ...
    /** `currentTransaction_7823.csv` -> `"7823"`. Case-insensitive on the extension only, per real SAF listings. */
