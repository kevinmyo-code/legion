...
class LedgerPendingDeltaDisjointTest {
    ...
    fun theTwoDeltaQueriesNeverCountTheSameRow() = kotlinx.coroutines.runBlocking {
        ...
        val provisional = dao.provisionalDeltaCentsAfter("4146", LedgerCurrency.USD, Long.MIN_VALUE)
        val pending = dao.pendingDeltaCents("4146", LedgerCurrency.USD)
    ...
    fun aVoiceLoggedRowNeverCountsTowardProvisionalDelta() = kotlinx.coroutines.runBlocking {
        ...
        assertEquals(null, dao.provisionalDeltaCentsAfter("4146", LedgerCurrency.USD, Long.MIN_VALUE))
        assertEquals(-8000L, dao.pendingDeltaCents("4146", LedgerCurrency.USD))
    }
    ...
    fun aFileDerivedRowNeverCountsTowardPendingDelta() = kotlinx.coroutines.runBlocking {
        ...
        assertEquals(-3000L, dao.provisionalDeltaCentsAfter("4146", LedgerCurrency.USD, Long.MIN_VALUE))
        assertEquals(null, dao.pendingDeltaCents("4146", LedgerCurrency.USD))
    }
