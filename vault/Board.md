...
| [[.scratch/backend-erp/map\|backend-erp]] | [[01-what-the-backend-owns\|01]] | grilling | What the backend owns: schema, truth, and the phone's residual role |
| [[.scratch/backend-erp/map\|backend-erp]] | [[06-supabase-feasibility\|06]] | research | Supabase feasibility on the real free tier |
...
|---|---|---|---|---|
| [[.scratch/backend-erp/map\|backend-erp]] | [[02-auth-and-identity\|02]] | grilling | Auth: two users now, more later, no roles ever  waiting on [[01-what-the-backend-owns\|01]] |
| [[.scratch/backend-erp/map\|backend-erp]] | [[03-the-gate-server-side\|03]] | grilling | The reconciliation gate when the truth lives remote  waiting on [[01-what-the-backend-owns\|01]] |
| [[.scratch/backend-erp/map\|backend-erp]] | [[04-mirror-and-cache-fate\|04]] | grilling | The xlsx mirror and the local cache in a backend world  waiting on [[01-what-the-backend-owns\|01]] |
| [[.scratch/backend-erp/map\|backend-erp]] | [[05-migration-path\|05]] | grilling | The migration path: 569 records to Postgres without a bad day  waiting on [[01-what-the-backend-owns\|01]], [[02-auth-and-identity\|02]], [[03-the-gate-server-side\|03]] |
...
| [[.scratch/backend-erp/map\|backend-erp]] | 6 | 6 | [[.scratch/backend-erp/backend-erp.canvas\|open]] |
